...
public class logueo extends javax.swing.JFrame {
    ...
    eU=udao.validarusuario(identificacion, user);
        if (eU.getUser()!=null && eU.getIdentificacion() !=null) {
          principal p=new principal();
            p.setVisible(true); /** setVisible es para que sea vidsible la ventana o interfaz principal**/
        }else {
        
            JOptionPane.showMessageDialog(this,"ingrese datos validos");
            txtusuario.requestFocus();/**requiesfocus es pára que el puntero regrese al txt usuario**/
        }
    }
